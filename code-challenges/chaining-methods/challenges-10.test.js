...
const divisibleByFiveTwoToThePower = (input) => {
  // Solution code here...
  let arr1, arr2, arr3, value1, value2;
  arr1 = input.map((val) => {
    value1 = val.filter(element => {
      if (element % 5 === 0) {
        return element
      }
    });
...
let findShortest = (data) => {
  // Solution code here...
  let theShort = starWarsData.reduce((acc, val) => {
